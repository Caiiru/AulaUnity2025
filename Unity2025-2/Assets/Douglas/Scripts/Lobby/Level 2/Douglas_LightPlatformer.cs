...
public class Douglas_LightPlatformer : MonoBehaviour
{
    ...
    void Awake()
    {
        gameManager = GameObject.FindFirstObjectByType<Douglas_GameManager>(); // Procura e atribui o objeto gameManager a variavel 
