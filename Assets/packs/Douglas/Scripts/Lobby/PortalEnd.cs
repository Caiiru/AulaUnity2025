...
public class PortalEnd : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            ProtalLobby portal = portalDestination.GetComponent<ProtalLobby>(); // Pega o script "ProtalLobby" do objeto de destino (Escrevi errado e agora n quero editar tudo kkkkkkkkkk) e adiciona a uma variavel portal
